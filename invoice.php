...
<html <?php echo HTML_PARAMS; ?>>
    <head>     
        ...
        <style>body { padding-top: 65px; } @media print {.noprint { display:none; } } #invoice { padding: 10px; } #store {width:50%; font-size:2rem; text-align:left; }  #logo { text-align:right !important; } </style>  
        ...
        <nav class="navbar navbar-expand-sm bg-secondary fixed-top hidden-print noprint">  
            ...
            <ul class="navbar-nav ml-auto ">        
                <li class="nav-item pl-2 pb-2">     
                    <a  class="btn btn-info nav-item" href="<?php echo tep_href_link('checkout_payment.php', '', 'SSL'); ?>">
                        <i class="far fa-arrow-alt-circle-left" aria-hidden="true"> </i>&nbsp;&nbsp;
                        <?php echo TEXT_BACK; ?></a> 
                </li>        
                <li class="nav-item pl-2 pb-2">    
                    <button id="printInvoice" class="btn btn-info nav-item" onclick="window.print();return false;">
        ...
        <div class="content  px-5">
            <div class="row align-items-center align-top">    
                <div class="col align-top">
                    <?php echo tep_image( 'images/' . STORE_LOGO, STORE_NAME); ?>
                </div>    
...
<?php
  if (tep_not_null($order->info['comments'])) {
            ...
            <div class="row border ">
                <div class="col-sm-12">    
                    <h5 class="mb-1">
                        <?php echo HEADING_ORDER_COMMENTS . '<small><a class="font-weight-lighter ml-2" href="' . tep_href_link('checkout_payment.php', '', 'SSL') . '">' .TEXT_EDIT . '</a></small>'; ?></h5>         
